        ...
        >
          ...
          <div className="p-6 bg-surface-soft border-b border-border">
            <div className="flex items-center gap-4">
              ...
              <div className="mt-5 flex items-center gap-2 rounded-xl bg-card border border-border px-4 py-3 shadow-md">
          ...
          <div className="p-6 border-b border-border">
            ...
            <div className="rounded-xl bg-surface-soft border border-border p-5 space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-foreground font-bold text-base">0.00 SOL · 0 YTR</span>
              </div>
              <div className="flex gap-3">
                <Button
                  variant="outline"
                  size="sm"
                   className="flex-1 h-11 min-h-11 border-border bg-card text-muted-foreground hover:bg-surface-soft"
          ...
          <div className="p-6 border-b border-border">
            ...
            <div className="overflow-x-auto pb-2 -mx-1 flex gap-4 snap-x snap-mandatory">
              {bookingsWithReceipts.length === 0 ? (
                <div className="w-full py-8 text-center rounded-xl bg-surface-soft border border-dashed border-border">
                  <p className="text-xs text-muted-foreground font-black uppercase tracking-widest">No tickets minted yet</p>
                </div>
              ) : (
                bookingsWithReceipts.map((booking) => {
                  ...
                  return (
                       <div key={booking.id}
                       className={`flex-shrink-0 w-48 snap-center rounded-xl border p-4 bg-card shadow-md ${longDistance ? 'border-accent/35' : 'border-primary/25' }`}
                    >
                      <p className="text-[10px] text-muted-foreground font-bold uppercase">MAR 06, 2026</p>
                      <p className="text-sm font-bold text-foreground mt-1 truncate">Butwal ➔ KTM</p>
          ...
          <div className="p-6 flex-1 bg-background">
            <nav className="space-y-2">
              {[
                ...
                >
                  <item.icon className="w-4 h-4 text-muted-foreground group-hover:text-cyan-400 transition-colors" />
                  {item.label}
                </button>
              ))}
            </nav>
