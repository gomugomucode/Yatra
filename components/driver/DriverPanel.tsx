...
export default function DriverPanel({
	...
	return (
		<div className="space-y-5">
			{/* ── Vehicle ID Card ── */}
			<div className="rounded-2xl border border-slate-100/60 overflow-hidden"
				...
				<div className="flex items-center justify-between px-4 py-3 border-b border-slate-100/40">
					...
					<Badge variant="outline"
						className={`text-[10px] px-2 py-0 ${bus.isActive ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-slate-100 text-slate-600 border-slate-200'}`}>
				...
				<div className="p-4 space-y-3">
					...
					<div className="flex items-center justify-between">
						...
						<span
							className="font-mono text-base font-bold tracking-widest text-white px-3 py-1 rounded-lg border border-slate-200"
					...
					{vehicleType && (
						<div className="flex items-center justify-between">
							...
							<Badge variant="outline" className="bg-slate-100 border-slate-200 text-slate-300 gap-1">
			...
			{/* ── Seat Dashboard ── */}
			<div className="rounded-2xl border border-slate-100/60 p-4 space-y-4"
			...
			{/* ── Location Sharing ── */}
			<div className="flex items-center justify-between px-4 py-3 rounded-2xl border border-slate-100/60"
